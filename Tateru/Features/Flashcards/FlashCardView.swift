...
struct FlashCardView: View {
    ...
    typealias FrontContentBuilder = (FlashCard) -> FrontContent
    typealias BackContentBuilder = (FlashCard) -> BackContent
    
    private let content: FlashCard
    ...
    private static func defaultFrontContent(from content: FlashCard) -> FrontContent {
        switch content {
    ...
    private static func defaultBackContent(from content: FlashCard) -> BackContent {
        switch content {
        case .character(let char):
